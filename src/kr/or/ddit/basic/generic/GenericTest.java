 ...
 * }
 * 
 * - 제네릭타입문자는 보통 영문자를 대문자를 1글자 사용한다.
 * - 많이 사용되는 제네릭타입문자
 *    <T> ==> Type
 *    <K> ==> Key
 *    <V> ==> Value
...
public class GenericTest {
   ...
   public static void main(String[] args) {
      ...
      mg1.setValue("우리나라");
      //mg1.setValue(200); --> 제네릭에 지정한 자료형이 아닌 데이터를 사용하면 오류발생!
   
      MyGeneric<Integer> mg2 = new MyGeneric<>();
      mg2.setValue(500);
      //mg2.setValue("가나다라"); --> 제네릭에 지정한 자료형이 아닌 데이터를 사용하면 오류발생!
   
      String temp = mg1.getValue(); // 형 변환 불필요
      int temp2 = mg2.getValue();
      System.out.println("제네릭 문자열 반환값 : "+temp);
      System.out.println("제네릭 정수형 반환값 : "+temp2);
      System.out.println("==========================================");
      ...
      //  --> 값을 꺼낼 때, 만약 데이터타입을 착각해서 잘 못 기입 시 에러메세지는 안뜨지만 오류발생
      String v2 = (String)non3.getValue();
